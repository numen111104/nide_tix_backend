    ...
    public function run(): void
    {
        $tourismPlaceList = [
            [
                ...
                'open_days' => 'Open Everyday',
                'open_time' => '09:00 - 20:00',
                'ticket_price' => 25000,
                'image_asset' => 'images/farm-house.jpg',
            ...
            [
                ...
                'location' => 'Lembang',
                'open_days' => 'Open Tuesday - Saturday',
                'open_time' => '09:00 - 14:30',
                'ticket_price' => 20000,
                'image_asset' => 'images/bosscha.jpg',
                'image_urls' => json_encode([
            ...
            [
                ...
                'open_time' => '24 hours',
                'ticket_price' => 'Free',
                'image_asset' => 'images/jalan-asia-afrika.jpg',
                'image_urls' => json_encode([
              ...
              [
                ...
                'ticket_price' => 3000,
                'image_asset' => 'images/stone-garden.jpg',
                'image_urls' => json_encode([
              ...
              [
                ...
                'open_time' => '24 hours',
                'ticket_price' => 'Free',
                'image_asset' => 'images/taman-film.jpg',
                'image_urls' => json_encode([
              ...
              [
                ...
                'open_days' => 'Open Saturday - Thursday',
                'open_time' => '09:00 - 15:30',
                'ticket_price' => 3000,
                'image_asset' => 'images/museum-geologi.jpg',
                'image_urls' => json_encode([
            ...
            [
                ...
                'ticket_price' => 20000,
                'image_asset' => 'images/floating-market.png',
                'image_urls' => json_encode([
            ...
            [
                ...
                'ticket_price' => 15000,
                'image_asset' => 'images/kawah-putih.jpg',
                'image_urls' => json_encode([
            ...
            [
                ...
                'open_time' => '24 hours',
                'ticket_price' => 20000,
                'image_asset' => 'images/ranca-upas.jpg',
                'image_urls' => json_encode([
            ...
            // Masukkan data lainnya seperti di atas
        foreach ($tourismPlaceList as $tourismPlace) {
            TouristDestination::create($tourismPlace);
        }
