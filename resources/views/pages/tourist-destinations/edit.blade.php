    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Edit Tourist Destination</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item"><a {{ route('home') }}>Dashboard</a></div>
                    <div class="breadcrumb-item"><a {{ route('tourist-destinations.index') }}>Tourist Destination</a></div>
            ...
            <div class="section-body">
                ...
                <div class="card">
                    <form action="{{ route('tourist-destinations.update', $tourist_destination->id) }}" method="POST"
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                is-invalid
                            @enderror"
                                    name="name" value="{{ $tourist_destination->name }}">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                is-invalid
                            @enderror"
                                    name="description" value="{{ $tourist_destination->description }}">
                                @error('description')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                is-invalid
                            @enderror"
                                    name="location" value="{{ $tourist_destination->location }}">
                                @error('location')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    class="form-control @error('open_days')
                                is-invalid
                            @enderror"
                                    name="open_days" value="{{ $tourist_destination->open_days }}">
                                @error('open_days')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    class="form-control @error('open_time')
                                is-invalid
                            @enderror"
                                    name="open_time" value="{{ $tourist_destination->open_time }}">
                                @error('open_time')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                is-invalid
                            @enderror"
                                    name="ticket_price" value="{{ $tourist_destination->ticket_price }}">
                                @error('ticket_price')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="file" class="form-control" name="image_asset"
                                        @error('image_asset') is-invalid @enderror>
                                    @error('image_asset')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="image-url-container"> <!-- Tambahkan container untuk input URLs -->
                                    @foreach (json_decode($tourist_destination->image_urls) as $imageUrl)
                                        <div class="input-group mb-3">
                                            <input type="text"
                                                class="form-control @error('image_urls') is-invalid @enderror"
                                                name="image_urls[]" value="{{ $imageUrl }}">
                            ...
                            <div class="form-group mb-0">
                                <label class="form-label w-100">Is Open?</label>
                                <div class="selectgroup selectgroup-pills">
                                    <label class="selectgroup-item">
                                        <input type="radio" name="is_open" value="1" class="selectgroup-input"
                                            {{ $tourist_destination->is_open == 1 ? 'checked' : '' }}>
                                        <span class="selectgroup-button">Buka</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="radio" name="is_open" value="0" class="selectgroup-input"
                                            {{ $tourist_destination->is_open == 0 ? 'checked' : '' }}>
                                        <span class="selectgroup-button">Tutup</span>
                                    </label>
                                </div>
                            </div>
